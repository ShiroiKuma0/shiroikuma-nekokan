...
/**
 * shiroikuma-nekokan fork — the jobs the data door has started, and the flag each of them watches
 * to stop. Copied from 自由作業盤's `AutomationJobs`.
 *
 * One at a time is not enforced here — a caller asking for two exports at once is asking for two
 * files, and refusing that is [SkAutomationDataService]'s business. What this owns is the mapping
